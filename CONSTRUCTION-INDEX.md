...
| This repository's own wiring and front door — a caller wires its own hook per-machine, as onboarding item 9 states | `.githooks/pre-commit` · `.github/workflows/` · [README.md](README.md) · `README.zh-CN.md` · `LICENSE` · `.gitignore` |
