...
| D8 | §13, new subsection «Review-subject version boundary» | s1 §3 absorbed (schema_version keying, no cross-version fallback, pinned v1 history) with its final bullet replaced by s2's successor text (digest-protected fields, pointer_for, authoring-call boundary from s2 §3), plus s1 §4's digest-strength disclosure (SHA-1 content addressing, stated not glossed) and s2 §4's five honesty notes (the plan first wrote "four"; corrected pre-submission — s2 §4 carries five bullets, recounted 2026-08-23) | s1 §3-4 · s2 §2-4 |
