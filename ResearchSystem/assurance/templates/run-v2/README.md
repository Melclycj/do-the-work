...
(`ResearchSystem/contract/Document-Work-Assurance-Contract-v3-supersession-1.md`) and the
...
`ResearchSystem/assurance/templates/run-v2/` against the run directory, zero copies. None
...
refs as CLI flags
(`python ResearchSystem/assurance/templates/run-v2/run_evidence_v2.py <run-dir> --base
--candidate --candidate-branch`;
`python ResearchSystem/assurance/templates/run-v2/run_bind_v2.py <run-dir> --evidence-commit
--bound-at [--emit]`;
`python ResearchSystem/assurance/templates/run-v2/run_repair.py <run-dir> [--emit]`;
`python ResearchSystem/assurance/templates/run-v2/run_retire.py <run-dir>`) — and every
...
the comparator itself (`ResearchSystem/document-harness/EXECUTION.md`'s frozen rule,
