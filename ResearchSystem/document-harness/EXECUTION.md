...
`ResearchSystem/assurance/templates/run-v2/README.md`, which now holds instantiation only.
...
1. **Mechanical reconciliation (2026-08-02 ruling).** Every enumeration the instruction
   ...
   `ResearchSystem/tooling/tests/` to four named paths, `build_run.py`'s list never received it, and the
