...
#: `<repo>/ResearchSystem/tooling/rsclib/document_harness/init_target.py` -> `ResearchSystem/`.
#: The same depth convention the rest of the instrument uses; it moves when the tree is
#: re-rooted, together with every other `parents[n]` in this package.
...
PROCEDURE = "ResearchSystem/document-harness/ONBOARDING.md, in the instrument repository"
